...
class UserDb {
  ...
  async addNewUser(data) {
    ...
    try {
      ...
      const userData = [uId, name, phone, email, password, address, cId, dob, status, confirmationCode, createdAt];
      let userQuery = 'insert into user (u_id,name,phone,email,password,address';
      // eslint-disable-next-line max-len
      userQuery += ',college,dob,emailStatus,confirmationCode,created_on) values(?,?,?,?,?,?,?,?,?,?,?)';
